...
import { DirectionalLight, director } from 'cc';
import { FeatureType, LightingEstimationConfig } from '../../../../../ar/component/framework/utils/ar-defines';
...
export class ARFeatureLightingEstimation extends ARFeature {
    ...
    protected onEnable (): void {
        ...
        if (handler && this.config) {
            handler.enableLightEstimate(this.config.enable);
        }
    }
    ...
    update (): void {
        ...
        if (this._mainLight) {
            ...
            this._mainLight.node.setWorldRotationFromEuler(dir[0], dir[1], dir[2]);
            this._mainLight.illuminance = Math.max(intensity[0], intensity[1], intensity[2]);
