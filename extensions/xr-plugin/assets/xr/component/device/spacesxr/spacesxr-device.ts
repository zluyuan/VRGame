...
import { Vec2 } from 'cc';
import { ARAPI, ARRayCastMode, ARAnchor, FeatureType, ARFeatureData } from '../../../../ar/component/framework/utils/ar-defines';
...
export class SpacesXRDevice extends ARDevice {
    ...
    async init (featuresDataset: ARFeatureData[]) {
        console.log('SpacesXRDevice init...');
    ...
    start (): void {
        console.log('SpacesXRDevice start');
    ...
    stop (): void {
        console.log('SpacesXRDevice stop');
    }

    resume (): void {
        console.log('SpacesXRDevice resume');
    }

    pause (): void {
        console.log('SpacesXRDevice pause');
    }
