...
export class XRSpacesRuntimeManager extends Component {
    ...
    private _activedFeatureManager: XRSpacesFeatureManager | null = null;
    ...
    protected enableFeature (featureType: XRSpacesFeatureType): void {
        ...
        const manager = this._featureManagerMap.get(featureType);
        if (manager) {
            this._activedFeatureManager = manager;
